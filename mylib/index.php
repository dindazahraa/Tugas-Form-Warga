...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light">SMK TARUNA BHAKTI</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Dinda Zahra | XII RPl 3</a>
        </div>
      </div>
...
<div class="container">
    ...
    <div class="py-3">
    <h2>Data Warga</h2>
        <a href="formdaftar.php" class='btn btn-success'>Tambah Data Warga</a>
    </div>
    <?php 
    if(isset($_POST['daftar'])){
    ?>
...
<?php 
    ...
    foreach($data_warga as $data){ 
        ...
        <tr>
            ...
            <td><a class="badge badge-primary" href="detailwarga.php?id=<?php echo $data['id']; ?>">detail</a> <a class="badge badge-danger" href="index.php?hapus=<?php echo $data['id']; ?>">Hapus</a></td>
        </tr>
    <?php } ?>
    </table>
    </div>
